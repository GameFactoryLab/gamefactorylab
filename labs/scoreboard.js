window.GameFactoryLabs=(()=>{
  ...
  const candidates=[
    ...
    {id:'gravity-flip',title:'Gravity Flip',key:'gf_candidate_gravity_flip_v1',total:null},
    {id:'bridge-snap',title:'Bridge Snap',key:'gf_candidate_bridge_snap_v1',total:null}
  ];
